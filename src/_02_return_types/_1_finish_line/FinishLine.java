	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
		 if (hasCrossedFinishLine()) {
			 JOptionPane.showMessageDialog(null, " The robot finished, it went this far:" + distance);
		 }
		 else if(hasCrossedFinishLine()==false)	{
			 JOptionPane.showMessageDialog(null, "The robot didn't finished, it went this far: " + distance);
		 }
